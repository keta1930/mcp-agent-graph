...
async def get_graph_run_attachments(
    graph_name: str,
    graph_run_id: str,
    ...
    """
    try:
        attachments = graph_run_storage.get_run_attachments(graph_name, graph_run_id, current_user.user_id)
        return attachments
    except Exception as e:
...
async def delete_graph_run_attachments(
    graph_name: str,
    graph_run_id: str,
    current_user: CurrentUser = Depends(get_current_user)
):
    ...
    """
    try:
        success = graph_run_storage.delete_run_attachments(graph_name, graph_run_id, current_user.user_id)
