...
- [🏗️ 开发详情](#️-开发详情)
- [🖼️ 前端功能展示](#️-前端功能展示)
    - [deepresearch - 深度研究系统](#deepresearch)
    - [corporate_ethics_dilemma_v2 - 企业伦理决策](#corporate_ethics_dilemma_v2)
    - [corporate_ethics_dilemma_v3 - 自动生成README](#corporate_ethics_dilemma_v3)
    - [mcp_manager - MCP管理器](#mcp_manager)
    - [graph_runner - 图运行器示例](#graph_runner)
- [📖 引用](#-引用)
- [⭐ 星标历史](#-星标历史)
