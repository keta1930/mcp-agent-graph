...
mcp = FastMCP(
    ...
    instructions="""This server provides access to the MAG graph 'Bilibili搜索循环测试' in sequential execution mode. 
...
def execute_agents(input_text: str, conversation_id: str = None) -> str:
    ...
    """
    try:
        payload = {"input_text": input_text, "graph_name": "Bilibili搜索循环测试", "parallel": False}
        if conversation_id:
